...
//    private String answerHMWithCoordinates;
//
//
//    //Testar ändra att ta bort aimRandomDir och ändra till return id
...
//
//
//    public void randomShot(RectangleCell[][] rectangles, int x, int y) {
//
//
...
//                        // shoots cannonball
//                       Platform.runLater( cannonBallAnswerUpdateMap(rectangles, x, y)); // if miss turn black if hits turn red.
//
...
//                        } else if (previousDirection.contains("UP")) {
...
//
//    // random shot
//    public String randomShotReturn(RectangleCell[][] rectangles) {
//        String guess = "";
...
//                //  guess = cannonBallAnswer(rectangles, x, y);
//
//                if (isCellBlack(rectangles, x, y) || !isActive(rectangles, x, y)) {
//                    totalMisses++;
//                } else if (isHit(rectangles, x, y)) {
...
//
//            } else {
//                guess = randomShotReturn(rectangles); // if cell is black or red(hit), shoot again
//            }
//        } else {
//
//            // if battleship isnt sunk
...
//
//    // follow up shots
//    public String followUpShot(RectangleCell[][] rectangles, int x, int y, Direction direction) {
//        String guessFollowUp = "";
//
...
//
//
////          randomShot(rectangles); // shoot again NOY SHOOT AGAIN
//                    guessFollowUp = randomShotReturn(rectangles);
//                }
//
//            } else {
//
...
//                            guessFollowUp = randomShotReturn(rectangles); // if its black or inactive, shoot again. IT SHOULD NOT SHOOT AGAIN
//                        } else { // if its not black and not inactive
//                            // cannonBall(rectangles, x, y); // shoot cannonball
//                           // guessFollowUp = (x) + "," + (y); // shoot cannonball
//                            guessFollowUp = (x) + "" + (y); // shoot cannonball
//
...
//                            guessFollowUp = randomShotReturn(rectangles); // if its black, shoot again
...
//                                resetLatestShotListAndPreviousDirection(); // might be needed to use initial shot
//                            }
//                        }
//                    }
...
//                                previousHit = true;
//                            } else { // if it misses
//                                resetLatestShotListAndPreviousDirection(); // start over
//                            }
//                        }
//
...
//
//
//    public String getAnswerHMWithCoordinates() {
//        return answerHMWithCoordinates;
//    }
//
//    public void setAnswerHMWithCoordinates(String answerHMWithCoordinates) {
//        this.answerHMWithCoordinates = answerHMWithCoordinates;
//    }
//}
