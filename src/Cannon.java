...
public class Cannon {
    ...
    private Rectangle[][] myBoardEnemyPlane;
    private Rectangle[][] myBoardMyPlane;
    ...
    public String randomShotId(RectangleCell[][] rectangles) {
        ...
        System.out.println(rectangles[x][y].getIsActive());
...
//innan var den bara void och returnera inget
    ...
    public String cannonBallRectangle(RectangleCell[][] rectangles, int x, int y) {
        if (rectangles[x][y].getIsShip()) {
            return "H ";

        } else {
            rectangles[x][y].setIsShip(false);
            return "M ";
        }
    }
